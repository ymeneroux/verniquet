...
ECHO ---------------------------------------------
ECHO STATION: IGNF - 1H15 STEP
ECHO ---------------------------------------------
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 08:05:00 -te 2023/11/09 09:20:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 09:15:00 -te 2023/11/09 11:30:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 11:30:00 -te 2023/11/09 12:45:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 12:45:00 -te 2023/11/09 13:00:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 13:00:00 -te 2023/11/09 14:15:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 14:15:00 -te 2023/11/09 15:30:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 15:30:00 -te 2023/11/09 16:45:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
%rtklib% log_gnss_02062023-20-08-04.obs rgp\ignf313z.23n rgp\\%base%313z.23o -ts 2023/11/09 16:45:00 -te 2023/11/09 18:00:00 -ti 5 -k test_%base%.conf > solution.pos & tail -n 1 solution.pos
